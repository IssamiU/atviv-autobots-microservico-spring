...
public class Seguranca extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
            ...
            .antMatchers("/usuario/**").hasAnyRole("ADMINISTRADOR", "GERENTE", "VENDEDOR")
            .antMatchers("/empresa/**").hasRole("ADMINISTRADOR")
            .antMatchers("/mercadoria/**").hasAnyRole("ADMINISTRADOR", "GERENTE", "VENDEDOR")
            .antMatchers("/servico/**").hasAnyRole("ADMINISTRADOR", "GERENTE", "VENDEDOR")
            .antMatchers("/venda/**").hasAnyRole("ADMINISTRADOR", "GERENTE", "VENDEDOR", "CLIENTE")
            .antMatchers("/veiculo/**").hasAnyRole("ADMINISTRADOR", "GERENTE", "VENDEDOR", "CLIENTE")
